...
/// <summary>
/// Main configuration settings for Tracezilla, including project identification,
/// type, name, and logging parameters.
/// </summary>
public class TracezillaSettings
{
    internal const string TRACEZILLA_NODE = "Tracezilla";
    /// <summary>
    ...
    /// <summary>
    /// HTTP service specific settings for Tracezilla.
    /// </summary>
    public TracezillaHttpServiceSettings Service { get; set; }
