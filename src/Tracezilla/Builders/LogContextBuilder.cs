...
/// log entries, exceptions, and diagnostics to be sent to Tracezilla.
/// </summary>
public class LogContextBuilder : ILogContextBuilder
{
    ...
    public LogContextBuilder(IOptions<TracezillaSettings> options, SensitiveDataMasker sensitiveDataMasker)
    {
    ...
    /// <summary>
    /// Gathers metadata about the current Tracezilla project such as ID, name, and type.
    /// </summary>
