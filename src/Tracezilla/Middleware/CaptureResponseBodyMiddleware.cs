...
/// </summary>
public class CaptureResponseBodyMiddleware(RequestDelegate next, IOptions<TracezillaSettings> options)
{
    /// <summary>
    ...
    private readonly TracezillaSettings _settings = options.Value;
