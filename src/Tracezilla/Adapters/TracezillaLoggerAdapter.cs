...
namespace Tracezilla.Adapters;

/// <summary>
/// Custom logger that stores log entries per HTTP request context.
/// </summary>
public class TracezillaLoggerAdapter : ILogger
{
    private readonly string _category;
    private readonly FormatterOptions _options;
    private readonly IHttpContextAccessor _httpContextAccessor;

    private const string LOGS_KEY = "__Tracezilla_Logger_Adapter_";

    /// <summary>
    /// Initializes a new instance of the <see cref="TracezillaLoggerAdapter"/> class.
    /// </summary>
    /// <param name="options">The logger options.</param>
    /// <param name="category">The logger category.</param>
    /// <param name="httpContextAccessor">HTTP context accessor.</param>
    public TracezillaLoggerAdapter(FormatterOptions options, string category, IHttpContextAccessor httpContextAccessor)
    {
