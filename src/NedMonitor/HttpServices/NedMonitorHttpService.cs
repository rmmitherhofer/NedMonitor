...
/// <summary>
/// HTTP service responsible for communicating with the NedMonitor logging endpoint.
/// </summary>
public class NedMonitorHttpService : HttpService, INedMonitorHttpService
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="NedMonitorHttpService"/>.
    /// </summary>
    ...
    /// <summary>
    /// Sends the given <see cref="LogContextRequest"/> to the NedMonitor API.
    /// </summary>
    ...
    /// <summary>
    /// Reads and prints the details from an HTTP error response returned by the NedMonitor API.
    /// </summary>
